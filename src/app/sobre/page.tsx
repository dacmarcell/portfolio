  ...
  return (
    <>
      <div className="flex flex-row">
        ...
        <FadeIn>
          <p className="mr-10 mt-10 text-lg text-start rounded-lg p-10 border border-white">
      ...
      <div className="flex flex-row mt-10">
        <FadeIn>
          <p className="ml-10 mt-10 text-lg text-end rounded-lg border border-white p-10">
      ...
      <motion.p
        className="text-md p-2 border border-white rounded-lg bg-grey-500/[0.8] w-1/2 m-auto mt-10 text-center text-bold"
      ...
      <div className="m-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <FadeIn className="text-lg">
          <p className="mt-10 border border-white p-10 rounded-lg">

        ...
        <div className="flex items-center justify-center text-dark rounded-md p-4">
          <FadeIn>
            <p className="text-lg">
              ...
              Next.js e Node.js. No back-end que é minha stack, atualmente
              utilizo C# e .NET para criação de aplicações. Também tenho
              projetos pessoais em Rust, Python e outras linguagens. Tenho um
              gato chamado Django e amo pizza. Sou curioso e inquieto. Sempre
              estudando algo novo ou fazendo algum projeto.
            </p>
          </FadeIn>
        </div>
      </div>
